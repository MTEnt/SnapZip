...
go vet ./...
go test -race ./...
python3 -m py_compile examples/draft_cache.py examples/context_code/cache_reference.py benchmarks/run.py benchmarks/stress_rbt.py benchmarks/suites/algorithm_20/*.py
